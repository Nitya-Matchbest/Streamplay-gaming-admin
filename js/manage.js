    ...
    const html = blogs.map(blog => {
        ...
        return `
            <div class="blog-card-manage">
                <img src="${imageUrl}" alt="${blog.title}" class="blog-image-thumb" onerror="this.src='data:image/svg+xml,%3Csvg xmlns=%22http://www.w3.org/2000/svg%22 width=%22150%22 height=%22100%22%3E%3Crect fill=%22%23ddd%22 width=%22150%22 height=%22100%22/%3E%3Ctext x=%2250%25%22 y=%2250%25%22 text-anchor=%22middle%22 dy=%22.3em%22 fill=%22%23999%22%3ENo Image%3C/text%3E%3C/svg%3E'">
                <div class="blog-info">
...
async function editBlog(blogId) {
    ...
    try {
        // Fetch blog details using the ID endpoint
        ...
        if (data.success && data.data) {
            ...
            if (!modal) {
                ...
                showError('Modal element not found in the page');
                return;
            }
